...
BattleBuddy — Claim Readiness Analysis (CRA)
...
BattleBuddy analyzes process completeness, not health facts.
...
BattleBuddy must refuse if asked to:
...
- `battlebuddy_cra/schema/cra.schema.json`

Output schema:

- `battlebuddy_cra/schema/cra_output.schema.json`
